                        ...
                        <div class="px-4 py-5">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <x-input id="start" type="date" name="start" class="mt-1 block w-full" required autofocus pattern="\d{4}-\d{2}-\d{2}"  :value="old('start', $race->event_start_at->toDateString())" />
                                    <x-input-error for="start" class="mt-2" />
                                </div>
                                <div class="col-span-6 sm:col-span-4">
                                    <x-label for="end" value="{{ __('End Date') }}" />
                                    <x-input id="end" type="date" name="end" class="mt-1 block w-full" pattern="\d{4}-\d{2}-\d{2}" :value="old('end', $race->event_end_at->toDateString())" />
                        ...
                        <div class="px-4 py-5">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <x-input id="title" type="text" name="title" class="mt-1 block w-full" required autocomplete="title" :value="old('title', $race->title)" />
                                    <x-input-error for="title" class="mt-2" />
                                </div>
                                <div class="col-span-6 sm:col-span-4">
                                    <x-label for="description" value="{{ __('Description') }}" />
                                    <x-input id="description" type="text" name="description" class="mt-1 block w-full" autocomplete="description" :value="old('description', $race->description)" />
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <x-input id="participants_total_limit" type="text" name="participants_total_limit" class="mt-1 block w-full" autocomplete="participants_total_limit"  :value="old('participants_total_limit', $race->getTotalParticipantLimit())" />
                        ...
                        <div class="px-4 py-5">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <x-input id="track" type="text" name="track" class="mt-1 block w-full" required autocomplete="track" :value="old('track', $race->track)" />
