<div class="inline-flex gap-2 items-center">
    ...
    <button type="button" wire:click="confirmPayment" class="inline-flex items-center gap-1 text-sm {{ $participant->payment_confirmed_at ? 'text-green-700 hover:text-green-900' : 'text-zinc-400 hover:text-zinc-700' }}">
