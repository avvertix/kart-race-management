...
class ChampionshipPointSchemeController extends Controller
{
    ...
    public function store(Request $request, Championship $championship)
    {
        $validated = $this->validate($request, [
            ...
            'points_config.rain_percentage' => 'required|numeric',
            'points_config.red_flag_percentage' => 'required|numeric',
            'points_config.small_category_percentage' => 'required|numeric',
            'points_config.small_category_threshold' => 'required|integer|min:1',
            'points_config.wildcard_points_mode' => 'required|in:as_other_drivers,fixed_points,ranked_from_first',
            'points_config.wildcard_fixed_points' => 'nullable|numeric|min:0',
