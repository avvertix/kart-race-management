...
class RemoveBonusFromParticipantWhenCostChangesTest extends TestCase
{
    ...
    public function test_bonus_not_removed_after_category_change_when_payment_confirmed(): void
    {
        config([
            'races.price' => 15000,
            'races.bonus_amount' => 0,
        ...
        $bonus = Bonus::factory()->recycle($championship)->create([
            'driver_licence' => 'D0001',
            'driver_licence_hash' => hash('sha512', 'D0001'),
            'amount' => 10000,
        ]);
    ...
    public function test_bonus_not_removed_after_category_change_when_payment_submitted(): void
    {
        config([
            'races.price' => 15000,
            'races.bonus_amount' => 0,
