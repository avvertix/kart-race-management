        ...
        <div class="px-4 py-5">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-jet-input id="driver_first_name" type="text" name="driver_first_name" class="mt-1 block w-full" :value="old('driver_first_name', optional($participant ?? null)->first_name)"  />
                    <x-jet-input-error for="driver_first_name" class="mt-2" />
                </div>
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="driver_last_name" value="{{ __('Surname') }}*" />
                    <x-jet-input id="driver_last_name" type="text" name="driver_last_name" class="mt-1 block w-full" :value="old('driver_last_name', optional($participant ?? null)->last_name)"  />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-jet-input id="driver_licence_number" type="text" name="driver_licence_number" class="mt-1 block w-full" :value="old('driver_licence_number', $driver['licence_number'] ?? null)"  />
                    <x-jet-input-error for="driver_licence_number" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="driver_nationality" value="{{ __('Nationality') }}*" />
                    <x-jet-input id="driver_nationality" type="text" name="driver_nationality" class="mt-1 block w-full" :value="old('driver_nationality', $driver['nationality'] ?? null)"  />
                    <x-jet-input-error for="driver_nationality" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="driver_email" value="{{ __('E-Mail') }}*" />
                    <x-jet-input id="driver_email" type="email" name="driver_email" class="mt-1 block w-full" :value="old('driver_email', $driver['email'] ?? null)"  />
                    <x-jet-input-error for="driver_email" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="driver_phone" value="{{ __('Phone number') }}*" />
                    <x-jet-input id="driver_phone" type="text" name="driver_phone" class="mt-1 block w-full" :value="old('driver_phone', $driver['phone'] ?? null)"  />
                    <x-jet-input-error for="driver_phone" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="driver_birth_date" value="{{ __('Birth date') }}*" />
                    <x-jet-input id="driver_birth_date" type="date" name="driver_birth_date" class="mt-1 block w-full" :value="old('driver_birth_date', $driver['birth_date'] ?? null)" pattern="\d{4}-\d{2}-\d{2}" />
                    <x-jet-input-error for="driver_birth_date" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="driver_birth_place" value="{{ __('Birth place') }}*" />
                    <x-jet-input id="driver_birth_place" type="text" name="driver_birth_place" class="mt-1 block w-full" :value="old('driver_birth_place', $driver['birth_place'] ?? null)"  />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-jet-input id="driver_medical_certificate_expiration_date" type="date" name="driver_medical_certificate_expiration_date" class="mt-1 block w-full" :value="old('driver_medical_certificate_expiration_date', $driver['medical_certificate_expiration_date'] ?? null)"   pattern="\d{4}-\d{2}-\d{2}"/>
                ...
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="driver_sex" value="{{ __('Sex') }}*" />
        ...
        <div class="px-4 py-5">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-jet-input id="competitor_first_name" type="text" name="competitor_first_name" class="mt-1 block w-full" :value="old('competitor_first_name', $competitor['first_name'] ?? null)"  />
                    <x-jet-input-error for="competitor_first_name" class="mt-2" />
                </div>
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="competitor_last_name" value="{{ __('Surname') }}*" />
                    <x-jet-input id="competitor_last_name" type="text" name="competitor_last_name" class="mt-1 block w-full" :value="old('competitor_last_name', $competitor['last_name'] ?? null)"  />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-jet-input id="competitor_licence_number" type="text" name="competitor_licence_number" class="mt-1 block w-full" :value="old('competitor_licence_number', $competitor['licence_number'] ?? null)"  />
                    <x-jet-input-error for="competitor_licence_number" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="competitor_nationality" value="{{ __('Nationality') }}*" />
                    <x-jet-input id="competitor_nationality" type="text" name="competitor_nationality" class="mt-1 block w-full" :value="old('competitor_nationality', $competitor['nationality'] ?? null)"  />
                    <x-jet-input-error for="competitor_nationality" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="competitor_email" value="{{ __('E-Mail') }}*" />
                    <x-jet-input id="competitor_email" type="email" name="competitor_email" class="mt-1 block w-full" :value="old('competitor_email', $competitor['email'] ?? null)"  />
                    <x-jet-input-error for="competitor_email" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="competitor_phone" value="{{ __('Phone number') }}*" />
                    <x-jet-input id="competitor_phone" type="text" name="competitor_phone" class="mt-1 block w-full" :value="old('competitor_phone', $competitor['phone'] ?? null)"  />
                    <x-jet-input-error for="competitor_phone" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="competitor_birth_date" value="{{ __('Birth date') }}*" />
                    <x-jet-input id="competitor_birth_date" type="date" name="competitor_birth_date" class="mt-1 block w-full" :value="old('competitor_birth_date', $competitor['birth_date'] ?? null)" pattern="\d{4}-\d{2}-\d{2}" />
                    <x-jet-input-error for="competitor_birth_date" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="competitor_birth_place" value="{{ __('Birth place') }}*" />
                    <x-jet-input id="competitor_birth_place" type="text" name="competitor_birth_place" class="mt-1 block w-full" :value="old('competitor_birth_place', $competitor['birth_place'] ?? null)"  />
        ...
        <div class="px-4 py-5">
            ...
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-jet-input id="mechanic_licence_number" type="text" name="mechanic_licence_number" class="mt-1 block w-full" :value="old('mechanic_licence_number', $mechanic['licence_number'] ?? null)" autocomplete="mechanic_licence_number" />
                    <x-jet-input-error for="mechanic_licence_number" class="mt-2" />
                </div>
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="mechanic_name" value="{{ __('Name and Surname') }}" />
                    <x-jet-input id="mechanic_name" type="text" name="mechanic_name" class="mt-1 block w-full" :value="old('mechanic_name', $mechanic['name'] ?? null)" autocomplete="mechanic_name" />
        ...
        <div class="px-4 py-5">
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-jet-input id="vehicle_chassis_manufacturer" type="text" name="vehicle_chassis_manufacturer" class="mt-1 block w-full" :value="old('vehicle_chassis_manufacturer', optional($participant ?? null)->vehicles[0]['chassis_manufacturer'] ?? null)"  autocomplete="chassis_manufacturer" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-jet-input id="vehicle_engine_model" type="text" name="vehicle_engine_model" class="mt-1 block w-full" :value="old('vehicle_engine_model', optional($participant ?? null)->vehicles[0]['engine_model'] ?? null)"  autocomplete="engine_model" />
                    <x-jet-input-error for="vehicle_engine_model" class="mt-2" />
                </div>
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="vehicle_oil_manufacturer" value="{{ __('Oil Manufacturer') }}*" />
                    <x-jet-input id="vehicle_oil_manufacturer" type="text" name="vehicle_oil_manufacturer" class="mt-1 block w-full" :value="old('vehicle_oil_manufacturer', optional($participant ?? null)->vehicles[0]['oil_manufacturer'] ?? null)"  autocomplete="oil_manufacturer" />
                    <x-jet-input-error for="vehicle_oil_manufacturer" class="mt-2" />
                </div>
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="vehicle_oil_type" value="{{ __('Oil Type') }}" />
                    <x-jet-input id="vehicle_oil_type" type="text" name="vehicle_oil_type" class="mt-1 block w-full" :value="old('vehicle_oil_type', optional($participant ?? null)->vehicles[0]['oil_type'] ?? null)" autocomplete="oil_type" />
                    <x-jet-input-error for="vehicle_oil_type" class="mt-2" />
                </div>
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="vehicle_oil_percentage" value="{{ __('Oil Percentage') }}*" />
                    <x-jet-input id="vehicle_oil_percentage" type="text" name="vehicle_oil_percentage" class="mt-1 block w-full" :value="old('vehicle_oil_percentage', optional($participant ?? null)->vehicles[0]['oil_percentage'] ?? null)"  autocomplete="oil_percentage" />
